...
This project implements **authenticated Lighthouse performance testing** for TestSuite applications (e.g. `planninghub`, `workhub`).
...
WS_USER=<username>
WS_PASS=<password>
WS_BASE=https://stage.test-suite.com/
